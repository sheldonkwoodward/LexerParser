...
public final class OberonParser implements OberonParserConstants { // Standard parser class setup...
    ...
    static String inputLocation = "standard input";
    ...
    public static void main(String args[]) {
        ...
        if(args.length == 1) {
            ...
            inputLocation = args[PATH_POS];

            try {
                input = new java.io.FileInputStream(args[PATH_POS]);
            } catch(java.io.FileNotFoundException e) {
                System.out.println("File not found.");
                return;
            }
        ...
        try {
            ...
            if(parseSuccessful) System.out.println("Parsing: success");
            else System.out.println("Parsing: failure");
...
/**************************************/
    ...
    static private String currentModule = "MODULE";
    static private int currentProcedureStartLine = -1;
    static String currentReturnType = "";
    static boolean currentFoundReturnType = false;
    static String currentParams = "";
    static boolean inProc = false;
    static boolean parseSuccessful = true;
    ...
    static final public void ProcedureDecl() throws ParseException {
        ...
        String procInfoOutput = "";
        currentProcedureStartLine = -1;
        currentReturnType = "";
        currentFoundReturnType = false;
        currentParams = "";
        inProc = false;
        if(!currentModule.equals("MODULE")) procInfoOutput += currentModule + ".";

        jj_consume_token(PROCEDURE);
        inProc = true;
        currentProcedureStartLine = token.beginLine;
        switch((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
            case 61: {
                ForwardDecl();
                break;
            ...
            case 62: {
                ProcDecl();
                procInfoOutput += token.image;
                procInfoOutput += " \"" + inputLocation + "\" ";
                procInfoOutput += "(" + currentProcedureStartLine + ") ";
                procInfoOutput += currentParams + " -> " + currentReturnType;
                break;
            }
            default:
                jj_la1[14] = jj_gen;
        ...
        jj_consume_token(55);
        if(pArg) System.out.println(procInfoOutput);
    }
    ...
    static final public void FPSection() throws ParseException {
        ...
        jj_consume_token(60);
        Type();
        if(!currentFoundReturnType) {
            currentReturnType = token.image;
            currentFoundReturnType = true;
            currentParams = "";
        }
        else {
            if(currentParams.length() != 0) {
                currentParams += ", " + token.image;
            }
            else currentParams = token.image;
        }
    }
        ...
        switch((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
            ...
            case IF: {
                ...
                try {
                    ...
                    System.out.println("Error: " + inputLocation + ", line " + token.beginLine + ": missing THEN in IF statement.");
                }
                StatementSeq();
                label_14:
                while(true) {
